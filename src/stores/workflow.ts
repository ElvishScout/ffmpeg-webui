...
export const useWorkflowStore = defineStore('workflow', () => {
  ...
  function exportCurrent(): string {
    return exportWorkflow({ ...graphStore.graph, name: graphStore.name || 'workflow' })
  }
  ...
  return { saved, currentId, refresh, save, saveAs, open, remove, newWorkflow, exportCurrent, importFromText }
})
