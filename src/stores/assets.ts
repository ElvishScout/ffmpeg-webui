...
import {
  listAssets, saveAsset, deleteAsset, updateAssetMeta, readAssetBytes,
  estimateQuota, type QuotaInfo,
} from '../data/assets'
...
export const useAssetsStore = defineStore('assets', () => {
  ...
  return { assets, quota, loading, byId, refresh, upload, remove, readBytes, durations }
})
