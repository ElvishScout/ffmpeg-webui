...
export const FILTER_REGISTRY: FilterSpec[] = [
  ...
  },
  {
    name: "hflip",
    category: "transform",
    desc: { zh: "水平翻转", en: "Horizontal flip" },
    inputs: [v],
    outputs: [v],
    params: [],
  },
  ...
  },
  {
    ...
    outputs: [v],
    params: [
      { key: "w", type: "string", default: "iw" },
      { key: "h", type: "string", default: "ih" },
      { key: "x", type: "string", default: "(ow-iw)/2" },
      { key: "y", type: "string", default: "(oh-ih)/2" },
    ...
    params: [
      {
        ...
        min: 1,
        max: 16,
        desc: { zh: "片段数（=输入口数）", en: "segment count (= input pads)" },
      },
    ...
    params: [
      {
        ...
        default: "in",
        options: [
          { value: "in", label: { zh: "淡入", en: "in" } },
          { value: "out", label: { zh: "淡出", en: "out" } },
        ],
      },
      {
        key: "st",
        ...
        min: 0,
        step: 0.1,
        desc: { zh: "开始时间（秒）", en: "start time (s)" },
      },
      {
        key: "d",
        type: "number",
  ...
  },
  {
    name: "loudnorm",
    category: "audio",
    desc: { zh: "响度标准化", en: "Loudness normalization" },
    inputs: [a],
    outputs: [a],
    params: [],
  },
  {
    ...
    params: [
      { key: "inputs", type: "number", default: 2, min: 2, max: 16 },
      {
        ...
        type: "select",
        default: "longest",
        options: [{ value: "longest" }, { value: "shortest" }, { value: "first" }],
      },
    ],
  },
  {
